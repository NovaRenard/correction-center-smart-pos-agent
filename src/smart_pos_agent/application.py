...
class Application:
    def __init__(self, settings: Settings, secret_store: SecretStore | None = None) -> None:
        ...
        self.operations = OperationManager(settings, self.repository, self.smart_pos)
        self.crm = CrmClient(settings, self.secret_store, self.operations)
